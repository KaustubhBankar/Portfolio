...
const Footer = () => {
  return (
    <footer className="relative overflow-hidden bg-black">
      ...
      >
        <h1 className="font-semibold loading-none text-white text-center select-none"
          style={{
        ...
        >Kaustubh Bankar</h1>
        <div className="h-[3px] w-24 md:w-32 rounded-full bg-gradient-to-r from-rose-300 via-pink-400 to-rose-500" />
        ...
        <p className="text-xs text-gray-400">
          &copy; {new Date().getFullYear()} Kaustubh Bankar. All right reserved.
        </p>
      </motion.div>
    </footer>
  )
