...
const Project = () => {
  ...
  const projects = useMemo(()=>[
    {
      title: "ITInteract",
      link: "https://itinteract.netlify.app",
      bgcolor: "#0d4d3d",
      image: isMobile ? img1 : photo1
    },
    {
      title: "Tomato",
      link: "https://tomato-food-delivery-app-ngqm.onrender.com/app",
      bgcolor: "#09877d",
  ...
  return (
    ...
    >
      <div className='sticky top-0 h-screen flex flex-col items-center justify-center'>
        ...
        <div className={`relative w-full flex flex-1 items-center justify-center ${isMobile ? "-mt-4" : ""}`}>
          {projects.map((project, idx)=>(
            ...
            >
              ...
              <div className={`relative w-full overflow-hidden bg-black/20 shadow-2xl md:shadow-[0_60px_-15px_rgba(0,0,0,0.7)]${isMobile ? "mb-6 rounded-lg" : "mb-10 sm:mb-12 rounded-xl"} h-[62vh] sm:h-[66vh]`}
        ...
        <div className={`absolute ${isMobile ? "bottom20" : "bottom-10"}`}>
          <a 
          target='_blank' 
