...
const socials = [
  ...
  { Icon: FaLinkedin, label: "LinkedIn", href: "https://www.linkedin.com/in/kaustubh-bankar-ab854a31a/" },
  { Icon: FaGithub, label: "Github", href: "https://github.com/KaustubhBankar" },
]
  ...
  return (
    <section id='home' className='w-full h-screen relative bg-black overflow-hidden'>
      ...
      <div className='absolute inset-0'>
        <div className='absolute -top-32 -left-32 w-[70vw] sm:w-[z-500vw] md:w-[40vw] h-[70vh] sm:h-[50vh] md:h-[40vh] max-w-[500px] max-h-[600px] rounded-full bg-gradient-to-r from-[#8e2de2] to-[#ff6bcb] opacity-30 sm:opacity-20 md:opacity-10 blur-[100px] sm:blur-[130px] md:blur-[150px] animate-pulse'>
        </div>

        <div className='absolute bottom-0 right-0 w-[70vw] sm:w-[z-500vw] md:w-[40vw] h-[70vh] sm:h-[50vh] md:h-[40vh] max-w-[500px] max-h-[600px] rounded-full  bg-gradient-to-r from-[#8e2de2] to-[#ff6bcb] opacity-30 sm:opacity-20 md:opacity-10 blur-[100px] sm:blur-[130px] md:blur-[150px] animate-pulse delay-500'>
        </div>
      </div>
      <div className='relative z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2'>
        <div className='flex flex-col justify-center h-full text-center lg:text-left relative  z-20'>
          <div className='w-full lg:pr-24 mx-auto max-w-[48rem]'>
            ...
            >
              <a href="#projects" className='px-6 py-3 rounded-full font-medium text-lg text-black bg-gradient-to-r from-green-500 to-blue-500 shadow-lg hover:scale-105 transition-all'>View My Work</a>
              <a href="/Kaustubh-Resume.pdf"
                download={true}
                className='px-6 py-3 rounded-full font-medium text-lg text-black bg-gradient-to-r from-green-500 to-blue-500 shadow-lg hover:scale-105 transition-all'
              >Resume</a>
            </motion.div>
